...
//dom content
var price = document.querySelector("#center>a:nth-child(1)");
var menu_price = document.querySelector(".menu-price")

price.addEventListener("mouseover" , ()=>{
  menu_price.classList.add("visible")
})
price.addEventListener("mouseout" , ()=>{
  menu_price.classList.remove("visible")
})

var resources = document.querySelector("#center>a:nth-child(3)");
var menu_resources = document.querySelector(".menu-resources")

resources.addEventListener("mouseover" , ()=>{
  menu_resources.classList.add("visible")
  menu_resources.style.transform = "translate(500% , 0%)";
  menu_resources.style.transition = "all 2s";
})
resources.addEventListener("mouseout" , ()=>{
  menu_resources.classList.remove("visible")
  menu_resources.style.transform = "translate(410% , -5%)";
  menu_resources.style.transition = "all 2s";
})